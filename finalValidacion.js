    ...
    function validarDato(){
        ...
        //validar numero telefonico:
            ...
            if (tel.value.length > 10) {
                ...
                errores.push("Su numero de telefono es incorrecto, no debe contener 0 al comienzo, ni letras");
                tel.classList.add("error");
            } else if (tel.value.length == 0) {
                errores.push("Necesita ingresar su numero de telefono");
                tel.classList.add("error");
            } else if(tel.value.length > 0 && tel.value.length < 10){
                errores.push("Su numero de telefono es muy corto, debe contener 10 caracteres.");
                tel.classList.add("error");
            } else {
        ...
        if (errores.length == 0) {
            let li = document.createElement("li");
            li.innerHTML = `¡Hola ${nombre} ${apellido} Bienvenido!, sus datos se han cargado correctamente, pronto nos pondremos en contacto...`;
